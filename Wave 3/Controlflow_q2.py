...
win_dict = {}
# Add your code here
for winners_list in winners.values() :
    for winner in winners_list :
        win_dict[winner] = win_dict.get(winner,0) + 1
 
win_list = []
for key,value in win_dict.items() :
    win_list.append((value,key))

new_list = sorted(win_list, reverse = True)
print (new_list)
num, director = new_list[0]

for number, name in new_list :
    if number == num :
        most_win_director.append((name,number))
